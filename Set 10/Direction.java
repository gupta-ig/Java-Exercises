public enum Direction {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Direction left to current direction is " + currentDirection.left());
        System.out.println("Direction right to current direction is " + currentDirection.right());
    }
}